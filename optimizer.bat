...
:help_RAM
cls
echo All instructions executed by the CPU(Central Processing Unit),program data and another parts of 
echo the pc are loaded into RAM(Random Access Memory).
pause>nul
goto help
